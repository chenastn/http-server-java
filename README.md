...
- Implemented basic TCP server that listens on port 4221
   - [TCP](https://www.cloudflare.com/en-ca/learning/ddos/glossary/tcp-ip/) is the underlying protocol used by HTTP servers. [This video gives a foundation for a basic TCP server program.](https://youtu.be/f9gUFy-9uCM?si=JI2Albx0Zzk6mlmR)
